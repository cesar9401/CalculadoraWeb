...
public class CalcController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("number1", number1);
        request.getSession().setAttribute("number2", number2);
        ...
        switch (option) {
            ...
            case 4:
                ...
                request.getSession().setAttribute("potencia", potencia);
                request.getRequestDispatcher("index.jsp").forward(request, response);
                break;
            case 5:
                String bin1 = Integer.toBinaryString(number1);
                String bin2 = Integer.toBinaryString(number2);
                request.getSession().setAttribute("binario1", bin1);
                request.getSession().setAttribute("binario2", bin2);
                request.getRequestDispatcher("index.jsp").forward(request, response);
                break;
        }
    }
